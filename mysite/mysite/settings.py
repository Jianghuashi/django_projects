...
INSTALLED_APPS = [
   ...
   # 'hello.apps.HelloConfig',
    ...
    'ads.apps.AdsConfig',
    #'ChucksList.apps.ChucksListConfif',
]
...
WSGI_APPLICATION = 'ChucksList.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Sophiajianghua$ads',
        'USER': 'Sophiajianghua',
        'PASSWORD': 'phone_8675309',
        'HOST': 'Sophiajianghua.mysql.pythonanywhere-services.com',
         'OPTIONS': {
...
try:
    ...
    print('When you want to use social login, please see ChucksList/github_settings-dist.py')
